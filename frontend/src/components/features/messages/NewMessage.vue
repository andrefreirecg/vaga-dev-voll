<template>
    <form class="flex justify-center flex-col gap-3" @submit="submit_message">
      <div class="grid grid-cols-12 gap-x-4">
        ...
        <input type="text" id="message" class="col-span-10 lg:col-span-11 border  rounded-md px-3 py-2 mb-4" v-model="message">
        <button type="submit" class="col-span-2 lg:col-span-1 flex justify-center items-center bg-blue-600 text-white rounded" @click="submit_message">
          <SendCheck />
        </button>
      </div>
    </form>
